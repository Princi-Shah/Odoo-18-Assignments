...
class Library(models.Model):
    ...
    librarian_id = fields.Many2one('res.users', string='Librarian', tracking=True)
    ...
    def _compute_capacity_status(self):
        ...
        description: function helps calculate the capacity status and perform criteria
                     based message in the library view
        returns: None
        """
        for record in self:
